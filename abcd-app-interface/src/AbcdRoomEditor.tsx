...
export function AbcdRoomEditor({ roomCopy, setRoomController, prefs, updatePrefs }: RoomEditorProps<Abcd>) {
  const ctlr = useStateController(() => {
    const ctlr = new StateController<typeof FormStructure, RoomConfig<Abcd>>(FormStructure, roomCopy);
